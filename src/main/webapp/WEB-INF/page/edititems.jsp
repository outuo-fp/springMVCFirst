...
<%@ include file="/WEB-INF/page/include/common.jsp"%>
				...
				<form class="form-horizontal" role="form" action="<%=basePath%>saveOritems.shtml" style="display:block;" method="post">
					...
					<input type="hidden" name="bomId" value="${userEdit.bomId}"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control"  id="ds_count" type="text"
									value="${userEdit.brand }" name="brand"/>
							</div>
							<label class="col-sm-2 control-label" for="ds_money">单价</label>
							<div class="col-sm-4">
								<input class="form-control" id="ds_money" type="text"
									value="${userEdit.price }" name="price" "/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4" >
								...
								<c:forEach items="${tbitemuser}" var="tbitem">
									<option value="${tbitem.proId}" >${tbitem.proId}</option>
								</c:forEach>
								</select>
